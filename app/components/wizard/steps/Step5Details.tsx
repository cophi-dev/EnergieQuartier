        ...
        <Controller
          ...
          render={({ field }) => (
            <Input
              ...
              min={1000}
              step={1000}
              className="w-full max-w-xs border-[#0A4D68]/20"
              {...field}
        ...
        <Controller
          ...
          render={({ field }) => (
            <div className="space-y-3 max-w-md">
              ...
              />
              <p className="text-sm font-semibold text-[#0A4D68] dark:text-[#00FFCA]">
                {field.value} Jahre
              </p>
            </div>
          )}
        ...
        <Controller
          ...
          render={({ field }) => (
            <textarea
              ...
              className="flex w-full rounded-lg border border-[#0A4D68]/20 bg-transparent px-3 py-2 text-sm outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 dark:bg-input/30 resize-y min-h-[100px]"
              {...field}
            />
          )}
        />
